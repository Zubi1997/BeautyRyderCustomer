            ...
            <View style={{ width: '90%', marginTop: 23, alignSelf: 'center' }} >
                ...
                <View style={{ width: windowWidth - 20 }} >
                    <FlatList
                        ...
                        numColumns={4}
                        renderItem={({ item }) =>
                            <View style={{ alignItems: 'center', marginHorizontal: 8, marginTop: 15, width: windowWidth / 5.5, }} >
                                <View style={{ width: '100%', height: windowWidth / 5.5, borderRadius: 100, backgroundColor: colors.blu }} />
